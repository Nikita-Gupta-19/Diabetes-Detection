...
class adminstration
{
		...
		void calcbill();           ///along with medicines and doctor fees if no medicines then only that
...
float bodytemp;
	...
	public:
        ...
        cout<<"\n\n Enter Age : ";
        cin>>age;
        cout<<"\n\n Do you Symptoms like becoming/having :\n\n 1>THIRSTY 2>Weight Loss 3>Fatigue 4>Vision Problem 5>Frequent Urination 6>Increased Hunger ??\n\n";
        cout<<" Enter Y for Yes : ";
        cin>>ch;
        if(ch=='y'||ch=='Y')
            cout<<"\n\n You may have the chances of diabetes, as these are the key symptoms of it!!";
        else
            cout<<"\n\n You may not have diabetes but still it is not sure!!";
        cout<<"\n\n Enter the weight : ";
        cin>>weight;
        ...
        cin>>blood;
        int bloodcount;
        cout<<"\n\n Enter Blood Count (WBC) : ";
        cin>>bloodcount;
        if(bloodcount<4500){
            cout<<"\n\n Blood Count (WBC) : Low -> "<<bloodcount;
        }
        else if(bloodcount>10000){
            cout<<"\n\n Blood Count (WBC) : High -> "<<bloodcount;
        }
		else{
			cout<<"\n\n Blood Count (WBC) : Ideal -> "<<bloodcount;
		}
        float ha;
        cout<<"\n\n Enter Haemoglobin : ";
        cin>>ha;
        if(ha>=12 && ha<16)
            cout<<"\n\n Haemoglobin level -> Normal : "<<ha<<" grams per deciliter";
        if(ha<12)
            cout<<"\n\n Haemoglobin level -> Low : "<<ha<<" grams per deciliter";
        if(ha>16)
            cout<<"\n\n Haemoglobin level ->  High : "<<ha<<" grams per deciliter";
        ...
        if(cholesterol<200)
            ...
            cout<<"\n\n Cholesterol -> Borderline High ->  "<<cholesterol<<" mg/dl";
        ...
        if(sugar>=80 && sugar<=100)
            ...
            cout<<"\n\n Very High Sugar Level : Diabetes Level 2 :-> Can led to heart attack ";
        else
            cout<<"\n\n Low Sugar Level : ";
        cout<<"\n\n This is on the basis of a simple test only please take appointment from doctor for clear understanding and complete treatment\n\n";
        ...
        if(sugar>100 && sugar<=125)
        {
            ...
            cout<<"Before Buying We would like you to take full test. ";
			cout<<endl;
            cout<<"\nIf you want to buy you can buy Press Y ";
			cout<<endl;
            cout<<"\nYour Choice : ";
            char ch2;
            cin>>ch2;
...
void Login::password()
{
	...
	char login[]="1234";                    // LOGIN CREDENTIALS
	char pass[]="1234";
	char iot;
	iot=getch();
    system("cls");
...
if(mainobj.id==tempid)
{
	...
	char tempdate;
	cin>>dd>>tempdate>>mm>>tempdate>>yyyy;
	...
	cin>>objp.headche;
	cout<<"\n\n\n";
	cout<<" 5:Do you feel fatigune?Enter the level(3-high||2-medium||1-low||0-no)? -> ";
	cin>>objp.fatigue;
	cout<<"\n\n\n";
	...
	cin>>objp.sugarlevel;
	cout<<"\n\n\n";
	cout<<" Enter the blood pressure(sys) : ";
	cin>>objp.blpressurenum;
	cout<<" Enter the blood pressure(dia) : ";
	cin>>objp.blpressuredem;
	cout<<"\n\n\n";
	cout<<"\n\n Enter the glucose level(sugar)(mg/dl)[This is Fasting Plasma Test(FPG)] -> : ";
	cin>>objp.glucoselevel;
	cout<<"\n\n Enter the glucose level(sugar 1)(mg/dl)[This is Oral Glucose Tolerance Test(OGTT)] -> : ";
	cin>>objp.glucose1;
	sleep(2);
	cout<<"\n\n Test complete...Your report will be delivered at your home till the next working day.";
	cout<<"\n\n\n";
...
{
if(objp.sugarlevel>=126)
{
cout<<" High Sugar Level-II\n";
checkdb2++;
checkdb3++;
}
else if(objp.sugarlevel<=125 && objp.sugarlevel>100)
{
cout<<" High Sugar Level\n";
checkdb2++;
}
else if(objp.sugarlevel>=80 && objp.sugarlevel<=100)
{
...
void diabetes::doctorlist()
{
	...
	cout<<" Your input : ";
	char tempmonth;
	cin>>date>>tempmonth>>month>>tempmonth>>year;
...
void diabetes::setlock()
{
	   ...
	   fadmin.open("admin.txt",ios::in);
	    if(c==0)
	    {
	   	cout<<"\n\n No id existed So please Sign up to do so\n\n";
	   	sleep(3);
	    admino.adminsi();
	    }
	    else
